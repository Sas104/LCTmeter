...
double frq, freq2=381300, freq3, freq4;
double freq1=543900;  //measured frequency when any external connection is absent. 
#define ccal 1e-9
...
void calcind(){
  ...
  double div=1.18e7;//39.4784*freq1*freq1;
  inductance=((f14*f14-1)*(f12*f12-1)/div)*1e9;
...
void calccap(){
  ...
  delay(1000);  //relay require 20ms to turn on. 10 times delay for sutained oscillation
  freq3=frequency();
